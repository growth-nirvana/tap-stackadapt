...
class StackAdaptDebugger:
    ...
    def compare_stats(
        ...
        for tracker in conversion_trackers:
            ...
            self._print_stats_summary(tracker_stats, f"Tracker: {tracker_name}", show_full_response=True)
    ...
    def _print_stats_summary(self, data: dict[str, Any], label: str, show_full_response: bool = False) -> None:
